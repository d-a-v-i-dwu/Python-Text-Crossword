...
def main(board):
    ...
    time.sleep(2)
    print("So here's the long awaited MERRY CHIRTSMAS BABYYYY!!!")
    time.sleep(1000)
...
def guess():
    global answer_list
    check = True
    wrong_answers = ["Not quite...", "Try again!", "Hmm maybe something else", "Nope sorry", "No bruh", "Maybe you spelt it wrong?", "1 IQ response"]
    questions()
    while check:
        print()
        answer = input("Answer: ")
